...
public class RequisitionManageAPIController {
    ...
    @ResponseBody
    public String payRequisition(@RequestParam("id") long requisitionId, @RequestParam("paykey") String paykey) {
        requisitionManageService.payRequisition(requisitionId, paykey);
        return JsonResponseBean.getSuccessResponse().toJson();
    }
