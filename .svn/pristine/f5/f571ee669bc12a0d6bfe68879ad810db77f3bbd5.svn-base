...
import com.ylife.goods.model.InfoImageManage;
import com.ylife.goods.model.UploadUtil;
import com.ylife.goods.service.GoodsImageService;
...
public class GoodsImageServiceImpl implements GoodsImageService {
     ...
     * 添加记录
     *
     * @param image {@link com.ysh.goods.bean.GoodsImage}
     * @return 添加的行数
     */
    @Transactional
     ...
     * 更新记录
     *
     * @param goodsImage 待更新的实体 {@link com.ysh.goods.bean.GoodsImage}
     * @param username   操作人名称
     * @return 更新的行数
     */
    @Transactional
     ...
     * @return 查询到的实体 {@link com.ysh.goods.bean.GoodsImage}
     */
     ...
     * {@link com.ysh.goods.bean.GoodsImage}
     */
