 ...
 * @version 1.0
 */
public class GoodsProductDetailVo implements Serializable {
    /*
     * 主键ID
     */
   ...
   * 商品图片
   */
    private List<GoodsImage> productImages;
    ...
    * 货品修改时间
    ...
    public List<GoodsImage> getProductImages() {
        return productImages;
    }

    public void setProductImages(List<GoodsImage> productImages) {
