...
public class GoodsInfo {
    ...
    //标识商品是否为第三方商品 0:不是第三方商品  1:第三方商品 2:B2B商品
    ...
    //商品扩展规格
    private List<ExtSpec> extSpecs;
    //商品扩展参数
    private List<ExParam> exParams;

    public List<ExParam> getExParams() {
        return exParams;
    }
    ...
    public void setExParams(List<ExParam> exParams) {
    ...
    public List<ExtSpec> getExtSpecs() {
        return extSpecs;
    }

    public void setExtSpecs(List<ExtSpec> extSpecs) {
        this.extSpecs = extSpecs;
    }
    ...
    public static class ExParam {
        ...
        private Long exParamId;

        private String name;

        private String value;

        public Long getExParamId() {
            return exParamId;
        }

        public void setExParamId(Long exParamId) {
            this.exParamId = exParamId;
        }
