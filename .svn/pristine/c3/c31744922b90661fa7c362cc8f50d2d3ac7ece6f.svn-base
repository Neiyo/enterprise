...
public class OrderServiceImpl implements OrderService {
    ...
    public List<Order> newsubmitOrder(long customerId, Long addressId, Long[] shoppingCartId, boolean isSelfPickUp, String remark, Long enterpriseId) {
        ...
        //2、提交订单
        List<Order> maps = submitOrder(customerId, addressId, goodsInfoList, isSelfPickUp, enterpriseId, null, true, remark);
        //3、修改所有购买商品为已经删除
    ...
    @Override
    @Transactional
    public List<Order> submitOrder(long customerId, Long addressId, long goodsInfoId, int count, boolean isSelfPickUp, Long enterpriseId, String operator) {
        Map<Long, Integer> goodsInfoList = new HashMap<>();
        goodsInfoList.put(goodsInfoId, count);
        return submitOrder(customerId, addressId, goodsInfoList, isSelfPickUp, enterpriseId, operator, true, "");
    }
     ...
     * @param remark        买家备注
     */
    public List<Order> submitOrder(long customerId, Long addressId, Map<Long, Integer> goodsInfoList, boolean isSelfPickUp, Long enterpriseId, String operator, boolean isValet, String remark) {
