...
<head>
    ...
    <style type="text/css">
        ...
        .update:hover,.delete:hover,.reset:hover,.update:active,.delete:active,.reset:active{
            background: #54a6de;
            color: #fff;
        }
        .arrow{
        ...
        #resetPasswordConfirm:hover{
        }
        #resetPasswordCancel:hover{
        }
...
<div class="allOutShow" style="background:#fff;margin-left: 20px; margin-top: 20px;margin-bottom: 20px;width: 100%;overflow-x: scroll;">
...
<div class="creatAccout allpop">
    <h1 style=" height:50px; line-height:50px; padding-left:20px; color:#000; font-size:20px;">新建下级账号<i onclick="discoverHtml()" id="xx"></i></h1>
    <ul>
        ...
        <li><abbr><i>*</i>登录密码:</abbr><input id="creatAccoutPassword" maxlength="16" type="password" /></li>
        <li><abbr><i>*</i>确认密码:</abbr><input id="creatAccoutNamePassConfirm" maxlength="16" type="password" /></li>
...
<div class="updateAcount allpop">
    <h1 style=" height:70px; line-height:70px; padding-left:20px; color:#000; font-size:20px;">编辑账号<i onclick="discoverHtml()" id="xx1"></i></h1>
    <ul>
