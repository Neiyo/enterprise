               ...
               if( data.response == 'success' ){
                   ...
                   var ChartData = {
                       ...
                       Circle:{
                           title: '',
                           contentArray: [
                               ['营销邮豆金额 :' + handleUndefinedZero(marketPrice),  handleNaNZero((marketPrice*10000)/((marketPrice + salePrice)*100))],
                               ['促销邮豆金额 :' + handleUndefinedZero(salePrice),  handleNaNZero((salePrice*10000)/((marketPrice + salePrice)*100))]
                           ],
                           seriesName: '占比',
                           callback:  function(){
